...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var defaultList:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			["Vaesea",				"vaesea",			"Main Creator of Vaesea Edition",						"https://www.youtube.com/@VaeseaGJ",	"FFFFFF"],
			["Dave And Bambi Team", "vdab",				"VS Dave And Bambi. Obviously.",						"https://gamebanana.com/mods/43201",	"FFFFFF"],
			["Notmrpolo and xmati", "ph",				"Wavy Background Tutorial",								"https://gamebanana.com/tuts/17332",	"FFFFFF"],
			["Uhard999",			"ph",				"Floating Character Script",							"https://gamejolt.com/@Uhard999",		"FFFFFF"],
			["Villezen",			"ph",			"Flash Camera Script Tutorial",		"https://www.youtube.com/channel/UCo0J58hC0TqrM7G8uaQilxA",		"FFFFFF"],
			["NotEpik",				"notepik",			"Kade Engine UI in Lua",		"https://www.youtube.com/channel/UCoxkY9FOleQvqzGXTSNmdiw",		"FFFFFF"],
			["Your Average FNF Pro", "stev",	"Dialogue Music from VS Stev",		"https://fridaynightfunking.fandom.com/wiki/Stev_(ur_avg_fnf_pro)",	"FFFFFF"],
			[""],
			["Psych Engine Team"],
